...
export default function ListCustomer() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch(`${API_URL}/customers?sort=-id&size=4${page}`);
                ...
                <div className="lg:w-1/3 w-full">
                    <div className="p-10">
                        <div className="mb-10 flex items-center justify-between">
                            <h1 className="font-bold">Customer CRUD App</h1>
                            <button className="bg-purple-700 text-white px-3 py-1.5 rounded" onClick={openModal}>Add
                                customer
                            </button>
                        </div>
                        <div className="">
                            {customers.length > 0 ? customers.map((customer, key) => <EachCustomer key={key}
                                                                                                   customer={customer}
                                                                                                   fetchData={fetchData}/>) : ''}
                        </div>
                        ...
                        {/* Start modal */}
                        <div className="relative z-10 hidden" aria-labelledby="modal-title" role="dialog"
                             aria-modal="true" id="new-modal">
                            ...
                            <div className="fixed z-10 inset-0 overflow-y-auto">
                                <div
                                    ...
                                    <div
                                        ...
                                        <form id="newform" onSubmit={storeProduct} method="post">
                                            <div className="bg-white">
                                                <div className="flex justify-between px-8 py-4 border-b">
                                                    <h1 className="font-medium">Create new customer</h1>
                                                ...
                                                <div className="px-8 py-8">
                                                    ...
                                                    <div className="mb-5">
                                                        <label
                                                            className="block text-gray-700 text-sm font-bold mb-2">Grade</label>
